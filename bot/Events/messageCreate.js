module.exports = {
    ...
    execute: async (message) => {
        ...
        // Exemple : loguer chaque message dans la console (utile pour le débogage)
        console.log(`${message.author.tag} a envoyé un message dans ${message.channel.name}: ${message.content}`);
    }
};
